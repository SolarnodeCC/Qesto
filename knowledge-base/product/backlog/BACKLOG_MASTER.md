...
_Last updated: 2026-08-14 (UTC) — **Sprint 94 shipped: verticals build (v6.2-dev).** Platform RELEASES unchanged (stays 6.2.0-dev; v6.2 GA at S95); ADR-0059 (ecosystem depth — extension data contracts & partner egress governance) accepted, opening Pentest #6 prep. LEARN assessment engine (`LEARN-SCORING-01` weights/partial-credit/curves) + LMS grade passback (`LEARN-GRADE-01`, OAuth1 body-hash POX, audit-logged) + L&D template gallery (`LEARN-TEMPLATES-01`). SOVEREIGN+ federation/egress exclusion (`SOVEREIGN-EXCLUSION-01`), verifiable signed audit export (`SOVEREIGN-AUDIT-API-01`, hash chain + HMAC), compliance posture matrix (`SOVEREIGN-POSTURE-01`). See [`SPRINT94_EXECUTION.md`](../releases/SPRINT94_EXECUTION.md). Next: S95 v6.2 GA (PULSE/LEARN/SOVEREIGN+) + CONNECT opens (federation trust model) + Pentest #6 run. Prior: 2026-07-31 — Sprint 93 shipped: v6.2-dev open (ADR-0058). See [`SPRINT93_EXECUTION.md`](../releases/SPRINT93_EXECUTION.md)._
