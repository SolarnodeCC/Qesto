...
| `IDEATE-BOARD-01` | IDEATE brainstorm + prioritization | 13 | P1 | S85–S86 | ✅ Backend shipped (S85) — `routes/ideate-sessions.ts`, `lib/session-room-ideate*.ts`, `lib/ideate-cluster.ts`; FE board = FE-IDEATE-BOARD-01 (S86). COMPETITIVE_EPICS E85 |
