...
_2026-06-19 — **EPIC-VALID accepted**: validation & demand-evidence discipline (7 stories, ~32 pts) from Founder's-Playbook review; governed by [`ADR-0064`](../../adr/ADR-0064-demand-evidence-adversarial-validation-gates.md) (**Accepted** 2026-06-19, RT-01). Demand-side gates (Sean Ellis/effort exit criteria, adversarial review, committed-vs-conditional horizon, non-goals contract, moat narrative, bottleneck map). See §EPIC-VALID._
...
**Governing ADR:** [`ADR-0064`](../../adr/ADR-0064-demand-evidence-adversarial-validation-gates.md) (**Accepted** 2026-06-19 — RT-01 `VALID-ADR-0064-ACCEPT`).
