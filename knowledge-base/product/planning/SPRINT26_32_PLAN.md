...
## Sprint 30 — Admin Engagement Analytics Maturity

**Goal:** Make engagement and realtime health visible to admins without log spelunking.

| Item | Size | Epic | Acceptance Signal |
|---|---:|---|---|
| ADMIN-ENGAGE-01: Energizer engagement funnel | 5 | ENT/OPS | Admin analytics shows activation, participation, completion, and dropout counts. |
| ADMIN-ENGAGE-02: Exportable engagement metrics | 5 | ENT/OPS | CSV export includes session-level energizer metrics using sanitized labels. |
| ADMIN-OPS-02: Realtime health correlation | 5 | OPS | Admin can compare energizer activity with WebSocket capacity, reconnect, and error signals. |
| PRIVACY-GAM-01: Engagement analytics privacy review | 3 | SECURITY | Docs and tests confirm no raw prompts, participant text, email, or tokens in analytics/export payloads. |

**Deferrals:** New chart-heavy redesign; keep analytics dense and operational.

## Sprint 31 — Enterprise Rollout Hardening

**Goal:** Apply enterprise controls to the newly expanded realtime surface.
...
**Deferrals:** Billing UI changes unless entitlement data proves a blocking support issue.

## Sprint 32 — v2.2 Release Candidate

**Goal:** Freeze the v2.2 engagement release candidate with documentation, rollout, and rollback readiness.
...
**Release Gate:** No v2.2 rollout until staging WebSocket validation passes with LIVE energizers enabled and disabled.
