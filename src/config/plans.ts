...
export const PLAN_DISPLAY: PlanDisplayMeta[] = [
  {
    id: 'free',
    name: 'Pulse',
    description: 'For one-off team pulses and workshop tests. Always free.',
    price: 0,
  ...
  },
  {
    id: 'starter',
    name: 'Signal',
    description: 'For facilitators running recurring rooms every week.',
    price: 29,
  ...
  },
  {
    id: 'team',
    name: 'Chorus',
    description: 'For HR, events, and compliance-heavy org-wide rollouts.',
    price: 99,
