...
const VARIANT_DEFAULTS: Record<AIBadgeVariant, { label: string; tooltip: string }> = {
  ...
  generated: { label: 'AI draft · Workers AI', tooltip: 'Drafted on Cloudflare\'s edge · no third-party model providers' },
  analyzed:  { label: 'AI recap · Workers AI', tooltip: 'Anchored to ranked evidence · edge inference · inside the same network as your session' },
}
