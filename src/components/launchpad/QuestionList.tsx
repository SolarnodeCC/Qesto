...
export default function QuestionList({
  ...
  return (
    ...
    >
      {/* Card header */}
      <div className="flex items-center justify-between gap-3 px-5 py-3.5 border-b border-[var(--color-border,#E5E5E5)] dark:border-[var(--color-border)]">
      ...
      {orderedQuestions.length === 0 && (
        <div className="px-5 py-4 space-y-4">
          <p className="text-sm text-[var(--text-muted,#737373)] dark:text-[var(--text-muted)]">{t('no_questions_hint')}</p>
            ...
            >
              {editingId === q.id ? (
                ...
                <div className="flex items-center gap-3 px-[18px] py-[13px] cursor-grab active:cursor-grabbing">
                  ...
                  <span className="font-mono text-xs text-[var(--text-muted,#737373)] dark:text-[var(--text-muted)] w-4 shrink-0">{index + 1}</span>
