      ...
      >
        ...
        <div className="flex items-center justify-between px-6 pt-5 pb-4 border-b border-pulse-200 dark:border-[var(--color-border)] flex-shrink-0">
          <div className="space-y-1">
            ...
            <p className="caption text-pulse-500 dark:text-[var(--text-muted)]" aria-live="polite">
          ...
          <button
            ...
            className="w-9 h-9 flex items-center justify-center rounded-lg text-pulse-500 dark:text-[var(--text-muted)] hover:text-pulse-800 hover:bg-pulse-100 dark:hover:text-[#F0F2F8] dark:hover:bg-[#1E2A45] focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500"
          >
