  ...
  return (
    <div className="space-y-6">
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          <div>
            ...
            <select
              ...
              className="w-full rounded-md border border-pulse-200 bg-white px-3 py-2 text-sm text-pulse-800 focus:outline-none focus:border-teal-400 focus:ring-2 focus:ring-teal-200"
            >
        ...
        <div className="flex flex-wrap gap-2">
          <button
            ...
            className="inline-flex items-center gap-2 rounded-md border border-pulse-200 bg-white px-4 py-2 text-sm font-medium text-pulse-700 hover:bg-teal-50 hover:border-teal-300 focus:outline-none focus:ring-2 focus:ring-teal-500 disabled:opacity-50"
          >
      ...
      {loading ? (
        ...
        <>
          <div className="overflow-x-auto rounded-lg border border-pulse-200">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-pulse-200 bg-pulse-50">
                  <th className="px-4 py-3 text-left font-medium text-pulse-700">Timestamp</th>
                  <th className="px-4 py-3 text-left font-medium text-pulse-700">User</th>
              ...
              <tbody className="divide-y divide-pulse-200">
                {events.map((event) => (
                  <tr key={event.id} className="hover:bg-pulse-50">
                    <td className="px-4 py-3 text-pulse-700">
                      {new Date(event.ts).toLocaleString()}
                    </td>
                    <td className="px-4 py-3 text-pulse-700 font-mono text-xs">
                    ...
                    <td className="px-4 py-3 text-pulse-600 text-xs">
          ...
          <div className="flex items-center justify-between">
            <div className="text-xs text-pulse-600">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="rounded-md border border-pulse-200 bg-white px-3 py-2 text-sm font-medium text-pulse-700 hover:bg-teal-50 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-teal-500"
              >
                Previous
              </button>
              <div className="flex items-center gap-1 text-xs text-pulse-600">
