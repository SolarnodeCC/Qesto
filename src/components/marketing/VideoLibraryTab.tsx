  ...
  return (
    <Card className="space-y-3">
      ...
      <select
        ...
        className="w-full body-s border border-pulse-300 dark:border-[var(--color-border-strong)] rounded-md px-3 py-1.5 bg-white dark:bg-[var(--color-surface-elevated)] text-pulse-900 dark:text-[var(--text-primary)]"
      ...
      <textarea
        ...
        rows={3}
        disabled={busy}
        className="w-full body-s border border-pulse-300 dark:border-[var(--color-border-strong)] rounded-md px-3 py-2 bg-white dark:bg-[var(--color-surface-elevated)] text-pulse-900 dark:text-[var(--text-primary)] placeholder:text-pulse-400"
      />
      <Button
        size="sm"
        variant="primary"
    ...
    <Card className="space-y-3">
      ...
      {previewUrl ? (
        ...
        <button
          type="button"
          onClick={preview}
          className="w-full rounded-md border border-pulse-300 dark:border-[var(--color-border-strong)] py-6 text-sm font-medium text-teal-600 dark:text-teal-400 hover:bg-pulse-50 dark:hover:bg-[#0F1526]"
        >
          Load preview
        </button>
      )}
