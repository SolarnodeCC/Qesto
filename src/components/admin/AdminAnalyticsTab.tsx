// ADR-0071 data-viz exception: inline SVG elements in this file (bar chart,
// donut ring) are required for programmatic chart rendering. Cannot be
...
function BarChart({ data, label }: { data: DailyBucket[]; label: string }) {
  ...
  if (data.length === 0) {
    return (
      <div className="flex items-center justify-center h-[120px] text-pulse-500 body-s">
        No data
      </div>
    )
  }
