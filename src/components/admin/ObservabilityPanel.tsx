        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Card className="space-y-1">
              ...
              <Caption className="text-pulse-500 text-[var(--text-muted)]">Throughput / hibernation events via Analytics Engine — not yet wired.</Caption>
            </Card>
            <Card className="space-y-1">
              ...
              {snapshot.components.vectorize.query_latency_ms !== null && (
                <Caption className="text-pulse-500 text-[var(--text-muted)]">describe() latency: {snapshot.components.vectorize.query_latency_ms}ms</Caption>
              )}
            </Card>
          </div>
