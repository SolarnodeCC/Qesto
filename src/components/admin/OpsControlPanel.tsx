  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      <select
        ...
        className="border border-pulse-300 dark:border-[var(--color-border-strong)] rounded-md px-2 py-1.5 text-body-s bg-white dark:bg-[var(--color-surface-elevated)] text-pulse-900 dark:text-[var(--text-primary)]"
        aria-label="Severity"
      >
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="space-y-3">
        ...
        <Card className="divide-y divide-pulse-100 dark:divide-[var(--color-border)] p-0">
          {ops.cron.map((j) => (
