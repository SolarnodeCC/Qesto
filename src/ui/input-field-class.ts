...
export const COMPACT_CODE_FIELD_CLASS =
  `w-16 bg-transparent py-1.5 px-1 text-sm font-mono font-semibold text-pulse-700 dark:text-[#F0F2F8] ${HINT_PSEUDO}:text-pulse-500 dark:${HINT_PSEUDO}:text-[#8A96B0] focus:outline-none`
