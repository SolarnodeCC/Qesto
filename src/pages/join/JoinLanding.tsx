        ...
        <div className="w-full max-w-sm space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <button
              ...
              className="w-full rounded-xl bg-teal-600 text-white text-sm font-semibold py-3 hover:brightness-110 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 transition-colors"
            >
              {t('joinButton')}
            </button>
          </form>
