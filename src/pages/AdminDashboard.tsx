    ...
    >
      <div className="max-w-6xl mx-auto px-6 lg:px-10 py-10 animate-page-enter space-y-6">
        ...
        <div
          ...
          className="flex flex-wrap gap-1 rounded-xl bg-pulse-100 dark:bg-[var(--color-bg-subtle)] p-1 w-full sm:w-auto overflow-x-auto"
        >
            ...
            <button
              ...
              className={[
                ...
                activeTab === id
                  ...
                  : 'text-pulse-500 dark:text-[var(--text-muted)] hover:text-pulse-800 dark:hover:text-[var(--text-secondary)]',
              ].join(' ')}
            >
              {icon}
              {label ?? t(labelKey)}
              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-4">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  <input
                    ...
                    className="text-body-s border border-pulse-300 dark:border-[var(--color-border-strong)] rounded-md px-3 py-1.5 bg-white dark:bg-[var(--color-surface-elevated)] text-pulse-900 dark:text-[var(--text-primary)] min-h-[44px]"
                  ...
                  <table className="w-full text-body-s">
                    ...
                    <tbody className="divide-y divide-pulse-100 dark:divide-[var(--color-border)]">
                      {historicalData.map((row, idx) => (
                        <tr key={`${row.bucket_ts}-${row.route ?? 'all'}-${idx}`} className="hover:bg-pulse-50 dark:hover:bg-[var(--color-bg-subtle)]">
