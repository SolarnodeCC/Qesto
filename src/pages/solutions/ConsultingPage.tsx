        ...
        <div className="max-w-6xl mx-auto px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            ...
            <div className="bg-white dark:bg-[#1C2540] rounded-[20px] overflow-hidden" style={shadowElevated}>
              <div className="bg-pulse-900 text-white px-8 py-6 flex justify-between items-center">
              ...
              <div
                className="px-8 py-3.5 bg-pulse-50 dark:bg-[#0F1525] border-t border-pulse-200 dark:border-[#1E2A45] flex justify-between text-[12px] text-pulse-500 dark:text-[#8A96B0]"
              >
        ...
        <div className="max-w-6xl mx-auto px-8">
          ...
          <div className="rounded-2xl overflow-hidden border border-pulse-200 dark:border-[#1E2A45] divide-y divide-pulse-200 dark:divide-[#1E2A45]">
            {whitelabel.map(({ key, value, sub }) => (
              <div
                key={key}
                className="bg-white dark:bg-[#151C2E] px-8 py-6 grid gap-8 items-start"
