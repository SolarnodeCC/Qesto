      ...
      <section className="py-16 md:py-20 bg-white dark:bg-[var(--color-bg)]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            ...
            {/* Deliverable card */}
            <div className="bg-white dark:bg-[var(--color-surface-elevated)] rounded-xl overflow-hidden" style={shadowElevated}>
              ...
              <div
                className="px-6 py-3.5 bg-pulse-50 dark:bg-[var(--color-bg-subtle)] border-t border-pulse-200 dark:border-[var(--color-border)] flex justify-between text-[12px] text-pulse-500 dark:text-[var(--text-muted)]"
              >
