      ...
      <section className="py-16 md:py-20 bg-white dark:bg-[var(--color-bg)]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            {/* Mode card */}
            <div className="bg-white dark:bg-[var(--color-surface)] rounded-xl p-6" style={shadowElevated}>
              {/* Tabs */}
              ...
              <div className="space-y-2.5 mb-3">
                {[1, 2].map((i) => (
                  <div key={i} className="flex items-center gap-3 p-3.5 rounded-xl bg-pulse-50 dark:bg-[var(--color-bg-subtle)]">
                    <div
              ...
              {/* Tally */}
              <div className="p-4 rounded-xl bg-pulse-50 dark:bg-[var(--color-bg-subtle)] space-y-2">
                {[
      ...
      <section className="py-16 bg-pulse-50 dark:bg-[var(--color-bg-subtle)]">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
            {[
              { label: 'Consent opt-in rate', value: '94%', note: 'Illustrative target · avg across deployed pulses, measured at session start.' },
              { label: 'Free-text response rate', value: '3.1×', note: 'Illustrative target · vs. identified surveys among the same cohorts.' },
