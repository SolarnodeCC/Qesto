    ...
    <MainLayout>
      ...
      <section className="py-16 md:py-20 bg-white dark:bg-[var(--color-bg)]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            ...
            {/* Minutes mockup */}
            <div
              className="bg-white dark:bg-[var(--color-surface-elevated)] rounded-xl p-8 relative"
              style={{ ...shadowElevated, fontFamily: 'var(--font-family-mono)', fontSize: 13, lineHeight: 1.8, color: '#262626' }}
            >
              <div
                className="absolute top-3 right-4 text-[11px] font-bold uppercase tracking-widest text-pulse-500 dark:text-[var(--text-muted)]"
                style={{ fontFamily: 'var(--font-family-body)' }}
              >
                Minutes · 2026-03-14
              </div>
              <div className="font-bold text-[20px] mb-4 text-pulse-900 dark:text-[var(--text-primary)] tracking-tight" style={{ fontFamily: 'var(--font-family-display)' }}>
                Q1 Board Meeting
              </div>
              ...
              <div className="mt-5 pt-3.5 border-t border-pulse-200 dark:border-[var(--color-border)] flex justify-between text-[11px] text-pulse-500 dark:text-[var(--text-muted)]" style={{ fontFamily: 'var(--font-family-body)' }}>
      ...
      <section className="py-16 bg-pulse-50 dark:bg-[var(--color-bg-subtle)]">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-pulse-200 dark:divide-[#1E2A45] bg-white dark:bg-[var(--color-surface)] rounded-2xl overflow-hidden">
            {[
              ...
              <div key={num} className="p-7">
                ...
                <p className="text-[13.5px] text-pulse-500 dark:text-[var(--text-muted)] leading-relaxed">{desc}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 gap-x-8">
            {checklist.map(({ title, desc }) => (
              <div key={title} className="flex gap-3 items-start">
                ...
                <span className="text-sm text-pulse-600 dark:text-[var(--text-secondary)]">
                  <strong className="text-pulse-900 dark:text-[var(--text-primary)] font-semibold">{title}</strong> {desc}
                </span>
              </div>
            ))}
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <blockquote className="max-w-3xl mx-auto text-center">
            ...
            <footer className="text-sm text-pulse-500 dark:text-[var(--text-muted)]">
              <strong className="text-pulse-900 dark:text-[var(--text-primary)]">Teodora Marin</strong> · Board Chair, regional arts foundation
            </footer>
          </blockquote>
        </div>
      </section>
      ...
      <section className="py-16 bg-white dark:bg-[var(--color-bg)]">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-pulse-500 dark:text-[var(--text-muted)] mb-6 text-lg leading-relaxed max-w-3xl">
