  ...
  return (
    <MainLayout>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            <div>
              ...
              <p className="text-lg text-pulse-500 dark:text-[var(--text-muted)] leading-relaxed mb-4">
              ...
              <p className="text-sm text-pulse-600 dark:text-[var(--text-secondary)] leading-relaxed mb-8">
                Clustering runs on Workers AI at the Cloudflare edge — inside the same network as your session, with no third-party model providers.
              </p>
              <div className="flex flex-wrap gap-3">
                <Link to="/login" className={btnPrimary + ' bg-gradient-brand text-base px-7 py-3.5'}>
                  See a sample recap
                </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              ...
              <div key={title} className="bg-white dark:bg-[var(--color-surface)] rounded-2xl p-7" style={shadowCard}>
                ...
                <div className="bg-pulse-50 dark:bg-[var(--color-bg-subtle)] rounded-lg p-3 text-[11.5px] text-pulse-900 dark:text-[var(--text-primary)] leading-relaxed" style={monoFont}>
                  {code.map((line, i) => (
                    <div key={i}>
                      {line.startsWith('//') ? (
      ...
      <Reveal as="section" className="py-16 bg-white dark:bg-[var(--color-bg)]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="bg-violet-50 dark:bg-violet-500/12 rounded-xl p-10 grid gap-5" style={{ gridTemplateColumns: '48px 1fr' }}>
