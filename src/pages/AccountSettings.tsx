      ...
      <div className="density-stack-8 max-w-[720px] mx-auto px-6 lg:px-10 py-10 animate-page-enter">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                {invoicesLoading ? (
                  ...
                  <ul className="mt-2 divide-y divide-pulse-100 dark:divide-[#1E2A45] rounded-lg border border-pulse-200 dark:border-[var(--color-border)]">
                    {invoices.map((inv) => (
        ...
        >
          {teamsLoading ? (
            ...
            <ul className="divide-y divide-pulse-100 dark:divide-[#1E2A45] rounded-lg border border-pulse-200 dark:border-[var(--color-border)]">
              {teams.map((team) => (
