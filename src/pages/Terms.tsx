      ...
      <div className="border-b border-pulse-200 pb-8 pt-14">
        <div className="max-w-6xl mx-auto px-8">
          ...
          <div className="flex gap-6 text-[13px] text-[var(--text-muted)]" style={monoFont}>
            <span><strong className="text-[var(--text-secondary)] font-semibold" style={{ fontFamily: 'var(--font-family-body)' }}>Version:</strong> 3.0.0</span>
            <span><strong className="text-[var(--text-secondary)] font-semibold" style={{ fontFamily: 'var(--font-family-body)' }}>Effective:</strong> 2026-01-15</span>
            <span><strong className="text-[var(--text-secondary)] font-semibold" style={{ fontFamily: 'var(--font-family-body)' }}>Governing law:</strong> Netherlands</span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-8">
        ...
        <div className="grid gap-16 py-24 md:grid-cols-[200px_1fr]">
          ...
          <main className="min-w-0">
            ...
            <h2 id="t1" className="font-bold text-[26px] tracking-tight text-[var(--text-primary)] mt-16 mb-4" style={displayFont}>
              1. The deal
            </h2>
            ...
            <h2 id="t2" className="font-bold text-[26px] tracking-tight text-[var(--text-primary)] mt-16 mb-4" style={displayFont}>
              2. Your account
            </h2>
            <p className="text-[15px] leading-relaxed text-[var(--text-secondary)] mb-4">
            ...
            <h2 id="t3" className="font-bold text-[26px] tracking-tight text-[var(--text-primary)] mt-16 mb-4" style={displayFont}>
              3. Acceptable use
            </h2>
            <p className="text-[15px] leading-relaxed text-[var(--text-secondary)] mb-3">Don't use Qesto to:</p>
            ...
            <p className="text-[15px] leading-relaxed text-[var(--text-secondary)] mb-2">
            ...
            <h2 id="t4" className="font-bold text-[26px] tracking-tight text-[var(--text-primary)] mt-16 mb-4" style={displayFont}>
              4. Your content
            </h2>
            <p className="text-[15px] leading-relaxed text-[var(--text-secondary)] mb-4">
            ...
            <h2 id="t5" className="font-bold text-[26px] tracking-tight text-[var(--text-primary)] mt-16 mb-4" style={displayFont}>
              5. Payment &amp; plans
            </h2>
            <p className="text-[15px] leading-relaxed text-[var(--text-secondary)] mb-4">
            ...
            <h2 id="t6" className="font-bold text-[26px] tracking-tight text-[var(--text-primary)] mt-16 mb-4" style={displayFont}>
              6. Service levels
            </h2>
            <p className="text-[15px] leading-relaxed text-[var(--text-secondary)] mb-4">
            ...
            <h2 id="t7" className="font-bold text-[26px] tracking-tight text-[var(--text-primary)] mt-16 mb-4" style={displayFont}>
              7. Termination
            </h2>
            <p className="text-[15px] leading-relaxed text-[var(--text-secondary)] mb-4">
            ...
            <h2 id="t8" className="font-bold text-[26px] tracking-tight text-[var(--text-primary)] mt-16 mb-4" style={displayFont}>
              8. Warranties
            </h2>
            <p className="text-[15px] leading-relaxed text-[var(--text-secondary)] mb-4">
            ...
            <h2 id="t9" className="font-bold text-[26px] tracking-tight text-[var(--text-primary)] mt-16 mb-4" style={displayFont}>
              9. Liability
            </h2>
            <p className="text-[15px] leading-relaxed text-[var(--text-secondary)] mb-4">
            ...
            <h2 id="t10" className="font-bold text-[26px] tracking-tight text-[var(--text-primary)] mt-16 mb-4" style={displayFont}>
              10. Disputes
            </h2>
            <p className="text-[15px] leading-relaxed text-[var(--text-secondary)] mb-4">
            ...
            <h2 id="t11" className="font-bold text-[26px] tracking-tight text-[var(--text-primary)] mt-16 mb-4" style={displayFont}>
              11. Misc
            </h2>
            <p className="text-[15px] leading-relaxed text-[var(--text-secondary)] mb-2">
