        ...
        <div className="space-y-3">
          ...
          {planGated ? (
            <div className="rounded-lg border border-violet-200 bg-violet-50 dark:bg-violet-900/20 dark:border-violet-700 p-5 space-y-3">
              <p className="body-s text-violet-800 dark:text-violet-300 font-medium">{t('aiInsightsPlanRequired')}</p>
              <p className="body-s text-violet-700 dark:text-violet-400">{t('upgradeForInsights')}</p>
            ...
            <p className="body-s text-pulse-500 dark:text-pulse-400">
            ...
            <div className="space-y-4">
              <p className="body-s text-pulse-500 dark:text-pulse-400">{t('insightsEmpty')}</p>
