    ...
    <section aria-labelledby="hero-heading">
      ...
      <div className="mt-8 flex flex-wrap gap-3">
        {townhallFeatureEnabled ? (
          <div ref={newMenuRef} className="relative">
            ...
            {newMenuOpen && (
              <div
                ...
                className="absolute left-0 z-20 mt-2 w-72 rounded-xl border border-pulse-200 dark:border-[var(--color-border-strong)] bg-white dark:bg-[var(--color-bg-subtle)] p-1.5 shadow-lg"
              >
                <button
                  type="button"
                  role="menuitem"
          ...
          <Button type="button" variant="inverse" onClick={onOpenWizard}>
            <Sparkles size={15} aria-hidden="true" />
            {t('newSession').replace('+ ', '')}
          </Button>
        )}
        ...
        <Button type="button" variant="secondary" disabled title={t('importComingSoon')} className="opacity-60">
          {t('importSession')}
        </Button>
      </div>
    </section>
