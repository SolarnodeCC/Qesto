  ...
  return (
    <MainLayout>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <p className="mt-4 text-lg text-pulse-600 dark:text-[var(--text-muted)]">{t('marketplace.subtitle')}</p>
          ...
          <Reveal as="ul" className="mt-8 grid gap-4 sm:grid-cols-2">
            {apps.map((app) => (
              ...
              >
                ...
                <p className="mt-2 text-sm text-pulse-600 dark:text-[var(--text-muted)]">{app.description}</p>
