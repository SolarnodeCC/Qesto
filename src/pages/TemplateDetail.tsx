...
function MagicLinkPanel({ link, onClose }: { link: string; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm" role="dialog" aria-modal="true">
      <div
        className="w-full max-w-md rounded-2xl bg-white dark:bg-[#111827] p-8"
            ...
            <div className="lg:sticky lg:top-24">
              ...
              >
                ...
                <button
                  ...
                  disabled={using}
                  className="w-full flex items-center justify-center px-8 py-3 rounded-xl font-medium text-white text-sm transition-all hover:scale-[1.02] focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 disabled:opacity-60 disabled:cursor-not-allowed"
                  style={gradientBrand}
                >
      ...
      <section className="py-14 bg-white dark:bg-[#0A0F1E]">
        <div className="max-w-xl mx-auto px-8 text-center">
          ...
          <button
            onClick={handleUseTemplate}
            disabled={using}
            className="inline-flex items-center justify-center px-12 py-3 rounded-xl font-medium text-white text-sm transition-all hover:scale-[1.02] focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 disabled:opacity-60"
            style={gradientBrand}
          >
            {using ? t('templates.creating') : t('templates.useTemplate')}
          </button>
