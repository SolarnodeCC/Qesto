        ...
        <div className="grid gap-16 py-24 pb-24" style={{ gridTemplateColumns: '200px 1fr' }}>
          ...
          <main className="min-w-0">
            ...
            <div className="bg-teal-50 dark:bg-teal-900/20 border border-teal-200 dark:border-teal-800 rounded-lg p-4 mb-8">
              ...
              <p className="text-[15px] text-pulse-700 dark:text-[#A8B3CC]">
                <a href="mailto:legal@qesto.cc" className="text-teal-600 hover:underline font-medium">
                  legal@qesto.cc
                </a>
              </p>
              <p className="text-[13px] text-pulse-500 dark:text-[#8A96B0] mt-1">
            ...
            <div className="flex gap-3 flex-wrap mb-8">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2 border border-pulse-300 dark:border-white/10 text-pulse-700 dark:text-[#A8B3CC] text-[14px] font-medium rounded-lg hover:bg-pulse-50 dark:hover:bg-white/5 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2"
              >
                Email abuse@qesto.cc
              </a>
            </div>
            <p className="text-[14px] text-pulse-500 dark:text-[#8A96B0] mb-4">
            ...
            <p className="text-[13px] text-pulse-500 dark:text-[#8A96B0] mb-4">
            ...
            <div className="bg-pulse-50 dark:bg-white/5 border border-pulse-200 dark:border-white/10 rounded-lg p-4 mb-4">
              <p className="text-[15px] font-semibold text-pulse-900 dark:text-[#F0F2F8]">
