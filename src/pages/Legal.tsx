    ...
    <MainLayout>
      ...
      <div className="border-b border-pulse-200 pb-8 pt-14">
        <div className="max-w-6xl mx-auto px-8">
          ...
          <h1
            className="font-bold tracking-tight text-pulse-900 text-[var(--text-primary)] mb-3"
          ...
          <div className="flex gap-6 text-[13px] text-pulse-500 text-[var(--text-muted)]" style={monoFont}>
            <span>
              <strong className="text-pulse-600 text-[var(--text-secondary)] font-semibold" style={{ fontFamily: 'var(--font-family-body)' }}>
                Updated:
              </strong>{' '}
              2026-06-30
            </span>
      ...
      <div className="max-w-6xl mx-auto px-8">
        ...
        <div className="grid gap-16 py-24 md:grid-cols-[200px_1fr]">
          ...
          <main className="min-w-0">
            ...
            <h2
              id="l1"
              className="font-bold text-[26px] tracking-tight text-pulse-900 text-[var(--text-primary)] mt-16 mb-4"
              style={displayFont}
            >
              1. Company details
            </h2>
            ...
            <p className="text-[15px] leading-relaxed text-pulse-700 text-[var(--text-secondary)] mb-2">
              ...
              <span className="text-xs text-pulse-500 text-[var(--text-muted)]">(full address available from KvK 88214503)</span>
            </p>
            <p className="text-[15px] leading-relaxed text-pulse-700 text-[var(--text-secondary)] mb-2">
            ...
            <div className="bg-teal-50 dark:bg-teal-900/20 border border-teal-200 dark:border-teal-800 rounded-lg p-4 mb-8">
              <p className="text-[15px] font-semibold text-pulse-900 text-[var(--text-primary)] mb-1">
                DSA Authority Contact
              </p>
              <p className="text-[15px] text-pulse-700 text-[var(--text-secondary)]">
                <a href="mailto:legal@qesto.cc" className="text-teal-600 hover:underline font-medium">
                  legal@qesto.cc
                </a>
              </p>
              <p className="text-[13px] text-pulse-500 text-[var(--text-muted)] mt-1">
            ...
            <ul className="list-disc pl-6 space-y-2 text-[15px] text-pulse-700 text-[var(--text-secondary)] mb-8">
              <li>
            ...
            <div className="flex gap-3 flex-wrap mb-8">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2 border border-pulse-300 dark:border-white/10 text-pulse-700 text-[var(--text-secondary)] text-[14px] font-medium rounded-lg hover:bg-pulse-50 dark:hover:bg-white/5 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2"
              >
                Email abuse@qesto.cc
              </a>
            </div>
            <p className="text-[14px] text-pulse-500 text-[var(--text-muted)] mb-4">
            ...
            <p className="text-[13px] text-pulse-500 text-[var(--text-muted)] mb-4">
            ...
            <div className="bg-pulse-50 dark:bg-white/5 border border-pulse-200 dark:border-white/10 rounded-lg p-4 mb-4">
              <p className="text-[15px] font-semibold text-pulse-900 text-[var(--text-primary)]">
            ...
            <div className="border-t border-pulse-200 dark:border-white/10 mt-24 pt-12">
              <p className="text-[13px] text-pulse-500 text-[var(--text-muted)]">
                Related documents:{' '}
