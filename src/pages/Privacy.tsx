    ...
    <MainLayout>
      ...
      <div className="border-b border-pulse-200 pb-8 pt-14">
        <div className="max-w-6xl mx-auto px-8">
          ...
          <h1 className="font-bold tracking-tight text-[var(--text-primary)] mb-3" style={{ ...displayFont, fontSize: 44 }}>
            Privacy Policy
          </h1>
          <div className="flex gap-6 text-[13px] text-[var(--text-muted)]" style={monoFont}>
            <span><strong className="text-[var(--text-secondary)] font-semibold" style={{ fontFamily: 'var(--font-family-body)' }}>Version:</strong> 2.2.0</span>
            <span><strong className="text-[var(--text-secondary)] font-semibold" style={{ fontFamily: 'var(--font-family-body)' }}>Effective:</strong> 2026-06-01</span>
            <span><strong className="text-[var(--text-secondary)] font-semibold" style={{ fontFamily: 'var(--font-family-body)' }}>Previous:</strong> 2026-01-15</span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-8">
        ...
        <div className="grid gap-16 py-24 md:grid-cols-[200px_1fr]">
          ...
          <main className="prose-content min-w-0">
            <p className="text-[17px] text-[var(--text-primary)] leading-relaxed mb-12">
            ...
            <h2 id="s1" className="font-bold text-[26px] tracking-tight text-[var(--text-primary)] mt-16 mb-4" style={displayFont}>
              1. Who we are
            </h2>
            ...
            <h2 id="s2" className="font-bold text-[26px] tracking-tight text-[var(--text-primary)] mt-16 mb-4" style={displayFont}>
              2. What we collect
            </h2>
            <h3 className="font-semibold text-[18px] text-[var(--text-primary)] mt-6 mb-2">Host responsibilities</h3>
            <ul className="list-disc pl-6 space-y-2 text-[15px] text-[var(--text-secondary)] mb-4">
            ...
            <h3 className="font-semibold text-[18px] text-[var(--text-primary)] mt-6 mb-2">Participant responsibilities</h3>
            <ul className="list-disc pl-6 space-y-2 text-[15px] text-[var(--text-secondary)] mb-4">
            ...
            <h3 className="font-semibold text-[18px] text-[var(--text-primary)] mt-6 mb-2">Educational use &amp; minors</h3>
            <p className="text-[15px] leading-relaxed text-[var(--text-secondary)] mb-4">
            ...
            <h2 id="s3" className="font-bold text-[26px] tracking-tight text-[var(--text-primary)] mt-16 mb-4" style={displayFont}>
              3. Consent posture
            </h2>
            <p className="text-[15px] leading-relaxed text-[var(--text-secondary)] mb-4">
            ...
            <h2 id="s4" className="font-bold text-[26px] tracking-tight text-[var(--text-primary)] mt-16 mb-4" style={displayFont}>
              4. How we use data
            </h2>
            <ul className="list-disc pl-6 space-y-2 text-[15px] text-[var(--text-secondary)] mb-4">
            ...
            <h2 id="s5" className="font-bold text-[26px] tracking-tight text-[var(--text-primary)] mt-16 mb-4" style={displayFont}>
              5. Sub-processors
            </h2>
            <p className="text-[15px] leading-relaxed text-[var(--text-secondary)] mb-3">The complete list:</p>
            <ul className="list-disc pl-6 space-y-2 text-[15px] text-[var(--text-secondary)] mb-4">
            ...
            <h2 id="s6" className="font-bold text-[26px] tracking-tight text-[var(--text-primary)] mt-16 mb-4" style={displayFont}>
              6. Retention
            </h2>
            <p className="text-[15px] leading-relaxed text-[var(--text-secondary)] mb-3">
            ...
            <h2 id="s7" className="font-bold text-[26px] tracking-tight text-[var(--text-primary)] mt-16 mb-4" style={displayFont}>
              7. Your rights
            </h2>
            <p className="text-[15px] leading-relaxed text-[var(--text-secondary)] mb-4">
            ...
            <h2 id="s8" className="font-bold text-[26px] tracking-tight text-[var(--text-primary)] mt-16 mb-4" style={displayFont}>
              8. AI &amp; inference
            </h2>
            <p className="text-[15px] leading-relaxed text-[var(--text-secondary)] mb-4">
            ...
            <h2 id="s9" className="font-bold text-[26px] tracking-tight text-[var(--text-primary)] mt-16 mb-4" style={displayFont}>
              9. Security
            </h2>
            <ul className="list-disc pl-6 space-y-2 text-[15px] text-[var(--text-secondary)] mb-4">
            ...
            <h2 id="s10" className="font-bold text-[26px] tracking-tight text-[var(--text-primary)] mt-16 mb-4" style={displayFont}>
            ...
            <h2 id="s11" className="font-bold text-[26px] tracking-tight text-[var(--text-primary)] mt-16 mb-4" style={displayFont}>
              11. Changes
            </h2>
            <p className="text-[15px] leading-relaxed text-[var(--text-secondary)] mb-4">
            ...
            <h2 id="s12" className="font-bold text-[26px] tracking-tight text-[var(--text-primary)] mt-16 mb-4" style={displayFont}>
              12. Contact
            </h2>
            <p className="text-[15px] leading-relaxed text-[var(--text-secondary)] mb-4">
