...
export default function Pricing() {
  ...
  return (
    <MainLayout>
      ...
      {/* Plans */}
      <Reveal as="section" className="pb-16 bg-white dark:bg-[var(--color-bg)]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 items-stretch">
            {/* Pulse */}
            <div className="bg-white dark:bg-[var(--color-surface)] rounded-xl p-8 flex flex-col relative" style={shadowCard}>
            ...
            {/* Signal — featured */}
            <div
              className="bg-pulse-900 text-white rounded-xl p-8 flex flex-col relative lg:-translate-y-2 dark:ring-1 dark:ring-teal-500/50"
      ...
      {/* Feature matrix */}
      <Reveal as="section" id="feature-matrix" className="py-16 bg-pulse-50 dark:bg-[var(--color-bg-subtle)] scroll-mt-20">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="bg-white dark:bg-[var(--color-surface)] rounded-2xl overflow-hidden" style={shadowCard}>
            <table className="w-full border-collapse">
              <thead>
                <tr>
                  <th className="text-left px-6 py-5 bg-pulse-50 dark:bg-[var(--color-bg-subtle)] text-xs font-bold uppercase tracking-widest text-pulse-500 dark:text-[var(--text-muted)] border-b border-pulse-200 dark:border-white/5 w-[38%]">
                    Capability
                  </th>
                  {(['Pulse', 'Signal', 'Chorus'] as const).map((p, i) => (
                    <th
                      key={p}
                      className={`px-6 py-5 bg-pulse-50 dark:bg-[var(--color-bg-subtle)] border-b border-pulse-200 dark:border-white/5 text-center text-[15px] font-bold tracking-tight ${
