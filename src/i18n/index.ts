...
const NAMESPACES = ['admin', 'auth', 'canvas', 'captions', 'common', 'components', 'connect', 'consent', 'dashboard', 'deliberate', 'embed', 'errors', 'home', 'ideate', 'insights', 'join', 'launchpad', 'learn', 'login', 'not-found', 'present', 'results', 'retro', 'session-config', 'sessions', 'settings', 'solutions', 'sovereign', 'stage', 'studio', 'team', 'townhall', 'vote', 'wizard']
