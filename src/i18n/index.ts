...
const NAMESPACES = ['admin', 'auth', 'common', 'components', 'consent', 'dashboard', 'errors', 'home', 'insights', 'join', 'launchpad', 'login', 'not-found', 'present', 'results', 'retro', 'session-config', 'sessions', 'settings', 'solutions', 'team', 'townhall', 'vote', 'wizard']
