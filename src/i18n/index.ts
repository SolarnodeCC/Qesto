...
const NAMESPACES = ['admin', 'auth', 'canvas', 'common', 'components', 'consent', 'dashboard', 'deliberate', 'embed', 'errors', 'home', 'ideate', 'insights', 'join', 'launchpad', 'login', 'not-found', 'present', 'results', 'retro', 'session-config', 'sessions', 'settings', 'solutions', 'stage', 'team', 'townhall', 'vote', 'wizard']
