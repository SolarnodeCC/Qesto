/** Max session title length (matches PatchSessionSchema). */
...
/**
 * Suggest a duplicate session title that does not collide (case-insensitive)
 * with any of the owner's existing session titles.
 */
