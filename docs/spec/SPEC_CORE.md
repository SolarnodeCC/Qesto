...
| **UI specialist** | Modes (present/vote/results) + plan limits → skeletons, upsell, disabled tools. UX constraints, colour/typography/spacing tokens, AI sparkle mark iconography, and component specs → [[SPEC_FRONTEND.md]] + [`docs/specs/WEBSITE_DESIGN_SPEC.md`](../specs/WEBSITE_DESIGN_SPEC.md). |
