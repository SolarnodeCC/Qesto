...
| Vector | DECISIONS_VECTORIZE, HELP_VECTORIZE, KB_VECTORIZE (1024d, cosine, bge-m3) — model + dim constants in `lib/embedding-model.ts` | `lib/{insights,help}-vectorize.ts`, `services/kbSearchService.ts` |
