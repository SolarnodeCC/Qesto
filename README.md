...
Technical specifications live under [`docs/spec/`](docs/spec/) (hub: [`docs/spec/INDEX.md`](docs/spec/INDEX.md)). Design tokens and visual system: [`docs/specs/design-tokens.README.md`](docs/specs/design-tokens.README.md).
...
npm run tokens:build                          # generate src/ui/tokens.ts from docs/specs/design-tokens.json
